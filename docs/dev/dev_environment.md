...
- `project_name`: the default docker compose project name (default: `nautobot-digital-twin`)
...
#14 naming to docker.io/nautobot-digital-twin/nautobot:3.0.0-py3.12 done
```
...
ee90fbfabd77   nautobot-digital-twin/nautobot:3.0.0-py3.12  "nautobot-server rqw…"   16 seconds ago   Up 13 seconds                                               nautobot_digital_twin_worker_1
b8adb781d013   nautobot-digital-twin/nautobot:3.0.0-py3.12  "/docker-entrypoint.…"   20 seconds ago   Up 15 seconds   0.0.0.0:8080->8080/tcp, :::8080->8080/tcp   nautobot_digital_twin_nautobot_1
d64ebd60675d   nautobot-digital-twin/nautobot:3.0.0-py3.12  "mkdocs serve -v -a …"   25 seconds ago   Up 18 seconds   0.0.0.0:8001->8080/tcp, :::8001->8080/tcp   nautobot_digital_twin_docs_1
...
So for example, our app is named `nautobot-digital-twin`, the command would most likely be `docker logs nautobot_digital_twin_nautobot_1 -f`. You can find the name of all running containers via `docker ps`.
